...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "INRyqz8BjOllXi9f8eOVTKZ_ZDUCduKzaICcSR36nPU" },
      { name: "application-name", content: `${site.name} | ${site.alias}` },
      { name: "apple-mobile-web-app-title", content: site.alias },
